...
#include "common/inc/Deque.h"
#include "common/inc/SpinLock.h"
...
private:
    ...
    core::StreamPool* stream_pool_;

    // deque of Processor, write by start or dispatch thread
    Deque<Processor*> processers_;

    std::vector<core::IQueue> up_queues_;
